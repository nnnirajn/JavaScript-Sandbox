...
var d = ++ c;    // pre increment have more priority
console.log(c);
console.log(d);

var e = c ++;      // post increment have less priority
console.log(c);
console.log(e);
...
<head>
  ...
  <title>JvaScript | Practice</title>
    </head>
         <body>
  <h1 onmouseenter="xyz()" onmouseleave="abc()" style="display: inline;">Niraj Narkhede</h1>   
  <!-- <h1 onmouseover="xyz()" onmouseout="abc()" style="display: inline;">Niraj Narkhede</h1>  -->  
...
<body>
         <p onmousedown="xyz(this,'red')" onmouseup="abc(this,'black')">Niraj Narkhede</p>
         <p onmousedown="xyz(this,'red')" onmouseup="abc(this,'black')">Suraj Narkhede</p>
         <p onmousedown="xyz(this,'red')" onmouseup="abc(this,'black')">Kiran Narkhede</p>
    <script>
            function xyz(a,b){
                    a.style.color = b;
                             }
...
<input type="text" id="username" name="username" onfocus="xyz(this)" onblur="abc(this)">
             <label for="surname">Surname:</label>
<input type="text" id="surname" name="surname" onfocus="xyz(this)" onblur="abc(this)">
      </form>
       <script>
          function xyz(a){
...
<input type="text" value="Niraj Narkhede" onselect="xyz()">
<p id="abc"></p>
<script>
      function xyz(){
        document.getElementById("abc").innerText = "You have Selected some text!!! ";
      }
</script>
...
<body>
  <form action="" onsubmit="xyz()">
    ...
    function xyz(){
        ...
        //alert("Your name : " + fname  + " Your surname : " + sname);
        document.getElementById("a1").innerText = fname;
        document.getElementById("a2").innerText = sname;
     }
</script>
</body>
</html>
...
<body>
    <p id="para1">Niraj Narkhede</p>
    <p id="para2"><span>Praful Narkhede</span></p>
    <div class="div1">Suraj Narkhede</div>
    <div class="div1">Uday Narkhede</div>
    <span>Sagar</span>  
    <span>Sandip</span>
    <span>suresh</span>
    <p name="girish">Girish Narkhede</p>

    <script>
                          //getElementById
       var one = document.getElementById("para1").innerText;
       console.log(one);           //using innerText  

       var two = document.getElementById("para2").innerHTML;
       console.log(two);          //using innerHTML

                       //getElementsByClassName
       var three = document.getElementsByClassName("div1");
       console.log(three);
       console.log(three.length);   // three is array....
       console.log(three[0].innerText);
       console.log(three[1].innerText);
                      
                      //getElementsByTagName
        var four = document.getElementsByTagName("span");              
        console.log(four);
        console.log(four.length);   // four is array....
        console.log(four[0].innerText);
        console.log(four[1].innerText);

                       //getElementsByName
        var five = document.getElementsByName("girish");  
        console.log(five);     
        console.log(five[0]);
        console.log(five[0].innerText);        
    </script>
